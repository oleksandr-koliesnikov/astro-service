...
class ChartRequest(BaseModel):
    ...
    timezone: str = Field(..., description="e.g. Europe/Kyiv или UTC+02:00")
    lat: float
    lng: float
    class Config:
        extra = "ignore"   # игнорируем лишние поля из n8n
...
def chart_endpoint(req: ChartRequest):
    ...
    pos = GeoPos(deg_to_dm_cardinal(req.lat, True), deg_to_dm_cardinal(req.lng, False))
